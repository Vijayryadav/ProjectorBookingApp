...
import com.example.projector_booking_app.model.Booking;
...
public class SendMail {
    ...
    public void sendBookingMailToThisUser(Booking booking, String projectorname){
        ...
        String message= "Dear " + FirebaseAuth.getInstance().getCurrentUser().getDisplayName() + ",\n\n"
                + "I hope this email finds you well. This is to confirm that you have successfully booked the AV Hall at " + projectorname + " for the time slot of " + booking.getBookingTime() + " on " + booking.getBookingDate() + ".\n\n"
        ...
        sendBookingMailtoAdmin(booking,projectorname);

    }

    private void sendBookingMailtoAdmin(Booking booking, String projectorname) {


        String message =
                "Dear Sistec Management,\n\n" +
                        "I hope this email finds you well. This is to confirm that a booking has been successfully made for the AV Hall at " + projectorname + ". The details of the booking are as follows:\n\n" +
        ...
        Thread thread = new Thread(() -> {
            try {
                ...
                mimeMessage.setFrom(new InternetAddress(senderEmail));
                mimeMessage.setSubject("Projector Booking Confirmation");
                mimeMessage.setText(message);
                Transport.send(mimeMessage);
                Log.i("send","successful");
            } catch (MessagingException e) {
